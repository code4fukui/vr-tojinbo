...
class RollerCoasterGeometry extends BufferGeometry {
	...
	constructor( curve, divisions ) {
		...
		for (let i = 1; i <= divisions; i++) {
			...
			//const euler = new Euler(forward.x, forward.y, forward.z);
			...
			extrudeShape(tube1, offset.set(0, -0.125, 0), color2); // center
			extrudeShape(tube2, offset.set(0.2, 0, 0), color1); // left
			extrudeShape(tube2, offset.set(-0.2, 0, 0), color1); // right
